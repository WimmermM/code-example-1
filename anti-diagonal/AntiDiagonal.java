public class AntiDiagonal {
   ...
   /**
   * Create and test a method called `getAntiDiagonalAvg` that takes a multidimensional array (only integeres)
   ...
   *  - write test for 2 different scenarios (test file is provided: AntiDiagonalTest.java)
   * 
   * Example cases:
   * [[1, 2, 3],
   * [3, 4, 6],
